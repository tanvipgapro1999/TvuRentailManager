...
using static TRMApi.Models.USerRolePairModel;
...
namespace TRMApi.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("Admin/AddRole")]
        public async Task AddARoles(UserRolePairModel pairing)
        {
        ...
        public async Task RemoveARoles(UserRolePairModel pairing)
        {
            string LoggedInUserId = User.FindFirstValue(ClaimTypes.NameIdentifier);
            var LoggedInUser = _userData.GetUserById(LoggedInUserId).First();
            var user = await _userManager.FindByIdAsync(pairing.UserId);
